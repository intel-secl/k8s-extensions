...
import (
	...
	v1beta1 "intel/isecl/k8s-custom-controller/crdSchema/api/hostattribute/v1beta1"
	scheme "intel/isecl/k8s-custom-controller/crdSchema/client/clientset/versioned/scheme"
