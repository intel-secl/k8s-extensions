...
import (
	...
	v1beta1 "intel/isecl/k8s-custom-controller/v4/crdSchema/api/hostattribute/v1beta1"
	scheme "intel/isecl/k8s-custom-controller/v4/crdSchema/client/clientset/versioned/scheme"
